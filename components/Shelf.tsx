...
export default function Shelf({ tipo, genre, country }: { tipo: MediaType; genre: string; country?: string }) {
  ...
  return (
    <div className="shelf">
      <div className="shelf-head">
        <h2>{genreLabel(genre)} <span style={{ color: "var(--faint)", fontWeight: 500, fontSize: "0.75em" }}>{tipo === "movie" ? "· Películas" : "· Series"}</span></h2>
