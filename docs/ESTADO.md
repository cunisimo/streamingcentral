...
| #15 | **Círculos vacíos en el selector de avatares** — causa confirmada (`loading="lazy"`, 21 de 31 nunca se pedían), corregido en `fix/avatares-sin-lazy`, esperando prueba en Preview |
